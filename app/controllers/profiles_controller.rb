class ProfilesController < ApplicationController
  ...
  def profile_params
    params.require(:profile).permit(:first_name, :last_name, :year, :major, :activities_and_clubs, :looking_for_place, :open_to_roommates, :max_price, :avatar, :about, :remove_avatar)
  end
end
